...
public class ProfileFragment extends Fragment {
    ...
    private void initListener() {
        ...
        binding.applyDataBtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String name = binding.nameBtn.getText().toString();
                String surname = binding.surnameBtn.getText().toString();
